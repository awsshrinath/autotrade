...
from config.config_validator import ConfigValidator, validate_current_config, run_config_tests
...
def main():
    ...
    validate_parser.add_argument("--env", choices=["development", "staging", "production"],
