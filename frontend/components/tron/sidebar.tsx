        ...
        <div className="h-full flex flex-col">
          <Link href="/" className="h-16 px-6 flex items-center border-b border-gray-200 dark:border-[#1F1F23]">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-500 dark:to-indigo-500 flex items-center justify-center">
          ...
          <div className="flex-1 overflow-y-auto py-4 px-4">
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-1">
                  <NavItem href="/analytics/pnl" icon={BarChart2}>
                    P&L Analysis
                  </NavItem>
                  <NavItem href="/analytics/risk" icon={Shield}>
                    Risk Monitor
                  </NavItem>
                  <NavItem href="/analytics/strategy" icon={LineChart}>
