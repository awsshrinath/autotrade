...
def test_run_strategy_once():
    ...
    trade_manager.strategy_map = {"mock_strategy": mock_strategy_function}

    # Simulate a trade run
    trade_manager.run_strategy_once(
        strategy_name="mock_strategy", direction="bullish", bot_type="stock"
    )
