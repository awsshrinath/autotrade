...
from runner.capital.portfolio_manager import create_portfolio_manager, get_current_capital
import os
import asyncio
...
class CapitalManager:
    ...
    def fetch_balance(self) -> float:
        ...
        try:
            ...
            if self.logger:
                self.logger.log_event(f"[CAPITAL] Available balance: ₹{available_balance:,.2f}")
    ...
    def get_position_size_recommendation(self, symbol: str, strategy: str, 
    ...
    def risk_check(self, trade_request: dict) -> tuple:
        ...
        """
        try:
            risk_passed, risk_message = self.portfolio_manager.risk_check_before_trade(trade_request)
    ...
    def update_position(self, symbol: str, quantity: int, price: float, 
                       strategy: str, position_type: str = 'stock'):
        """
